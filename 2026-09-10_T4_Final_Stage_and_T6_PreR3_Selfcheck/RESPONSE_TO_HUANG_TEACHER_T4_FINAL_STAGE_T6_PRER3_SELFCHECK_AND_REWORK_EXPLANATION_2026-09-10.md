...
状态：提交黄老师审阅。T6进入R3前自查已完成并通过本地审计；T4科学/评测内容和R4外置三文件封口均已完成并通过本地审计。
...
T4-R4外置closure三文件已经返回并通过本地审计。本包保留中立两选项请您裁定：
...
当前按您“先回传自查再谈重跑”的要求提交T6进入R3前自查，同时提交已经完成最终封口的T4材料：
